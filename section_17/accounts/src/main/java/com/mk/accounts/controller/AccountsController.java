...
import com.mk.accounts.service.IAccountService;
...
@Tag(
        name = "CRUD REST APIs for Accounts in MKBank",
        description = "CRUD REST APIs in MKBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside MKBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
